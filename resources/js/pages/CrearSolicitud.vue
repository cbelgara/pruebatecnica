            ...
            <form @submit.prevent="storeSolicitude" method="POST">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            <label for="email_confirmation" class="form-label">Confirmar correo </label>
                        ...
                        <div class="col-lg-4 mb-3">
                            <label for="tipo_documento" class="form-label">Documento de indentificación </label>
                        ...
                        <div class="col-lg-4 mb-3">
                            <label for="cui" class="form-label">CUI/Pasaporte</label>
                        ...
                        <div class="col-lg-4 mb-3">
                            <label for="cui" class="form-label">Documento de Identificación</label>
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <select id="departamento" class="form-select" required>
                                ...
                                <option value="3">Petén</option>
                                <option value="4">Quetzaltenango</option>
                                <option value="5">Totonicapán</option>
                                <option value="6">Jalapa</option>
                            </select>
                        </div>
                        <div class="col-lg-4 mb-3">
